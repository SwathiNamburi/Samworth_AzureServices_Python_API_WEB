...
@allure.story("Invalid Source")
@allure.severity(allure.severity_level.CRITICAL)
def test_ASB_message_with_invalid_source(driver):
    ...
    # BUILD PAYLOAD
    # ==========================================
    payload_str, event_id, input_time = api.get_payload("get_event_invalid_source.json")
    ...
    fresh_service_incident_page.search_and_capture_incident(event_id, "Invalid source - urn:sb")
