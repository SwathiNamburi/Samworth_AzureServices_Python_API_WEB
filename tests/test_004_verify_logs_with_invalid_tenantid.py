...
@allure.story("Invalid Tenant ID")
@allure.severity(allure.severity_level.CRITICAL)
def test_create_event_with_invalid_tenantid(driver):
    api = APICalls()
    ...
    response_body, input_event_id = api.create_event_api_call("create_event_invalid_tenantid.json")
    ...
    runtime_manager_page.goto_runtime_verify_logs_event_id_matched(response_status,input_event_id)  # Select Runtime Manager
