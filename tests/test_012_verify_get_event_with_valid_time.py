...
@allure.story("Valid Start Time")
@allure.severity(allure.severity_level.NORMAL)
def test_get_events_with_valid_start_time(driver):
    ...
    response, response_body = api.get_events_api_call_without_tenantid(input_time)
    # ==========================================
    ...
    runtime_manager_page.goto_runtime_verify_latest_logs_matched(response.status_code,input_time)
